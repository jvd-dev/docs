...
Com a execução desse request, serão obtidas informações relacionadas ao saldo disponível para a operação, juntamente com detalhes sobre as taxas praticadas, e o Id da simulação Essa informação é extremamente importante para a criação da proposta no sistema. Veja abaixo um exemplo de response:
